...
void handleMouseEvent(INPUT_RECORD ir, HANDLE output, checkbox *cb1, checkbox *cb2, checkbox *cb3);
void handleKeyboardEvent(INPUT_RECORD ir, HANDLE output, checkbox *cb1, checkbox *cb2, checkbox *cb3);
...
int main(int argc, char const *argv[])
{
  ...
  checkbox cb1(2, 2, "bread");
  checkbox cb2(2, 3, "milk");
  checkbox cb3(2, 4, "eggs");
  std::cout << "-------CHECKLIST---------\n";
  cb1.draw();
  cb2.draw();
  cb3.draw();

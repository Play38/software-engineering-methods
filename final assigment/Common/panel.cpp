...
{
	if (!items[currentFocus]->canGetFocus())
	{
...
void Panel::keyDown(int keyCode, char character, Graphics &g)
{
	items[currentFocus]->keyDown(keyCode, character, g);
}
